#ifndef CODE_UTILITIES_V3_H // Garanti de ne pas inclure 2 fois le même fichier dans la séquence de prétraitement
#define CODE_UTILITIES_V3_H
...
namespace BdB
{
    ...
    //ALEXIS ajouté 2e paramètre pour passer à printw() qui remplace cout avec ncurses
    inline int waitKeyToPress(char keyToPress = {}, const char* textToPrint = {})
    {
        int keyPressed = {};
        ...
        //ALEXIS afficher le texte si il est passé en paramètre
    	if(textToPrint != NULL)
    		printw(textToPrint);
    ...
    inline void pressToContinue(string s = "")
    {
        ...
        //ALEXIS conversion du string s en char
#if defined(_WIN32) || defined(_WIN64)
        cout << s;
        waitKeyToPress();
#else
